...
**To Do List** is a Simple Project to Display To Do List
...
```sh
  git clone https://github.com/abiola-arobieke/to-do-list.git
```
...
Feel free to check the [issues page](https://github.com/abiola-arobieke/to-do-list/issues).
